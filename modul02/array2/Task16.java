...
/* Магическим квадратом порядка n называется квадратная матрица размера nxn, составленная из чисел 1, 2, 3, ...,n2  так, что суммы по каждому столбцу,
...
public class Task16 {
	public static void main(String[] args) {
		...
		if ((n - 1) % 2 == 0) {
			...
			System.out.println("\nМагический квадрат четно-четного порядка:");
			for (int[] array : square) {
				for (int element : array) {
					System.out.printf("%4d ", element);
				}
